 ...
 * @method self toolbarClassName($value) Toolbar dom 类名
 * @method self bodyClassName($value) Body dom 类名
 * @method self asideClassName($value) Aside dom 类名
 * @method self headerClassName($value) Header 区域 dom 类名
