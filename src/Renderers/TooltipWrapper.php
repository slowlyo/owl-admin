 ...
 * @method self showArrow($value = true) 是否展示浮层指向箭头
 * @method self enterable($value = true) 是否鼠标可以移入到浮层中
 * @method self disabled($value = true) 是否禁用浮层提示
 ...
 * @method self rootClose($value = true) 是否点击非内容区域关闭提示
 * @method self inline($value = true) 内容区是否内联显示
