...
const useApp = () => {
    ...
    const requestSettings = useRequest(fetchSettings, {manual: true, retryCount: 3, cacheKey: 'app-settings'})
    ...
    const requestRoutes = useRequest(fetchUserRoutes, {manual: true, cacheKey: 'app-dynamic-routes'})
    // 获取路由
